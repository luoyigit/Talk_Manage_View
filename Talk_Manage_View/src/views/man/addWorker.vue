    ...
    <div>
        <el-card class="box-card" header="基础信息">
            ...
            <div style="background-color: white">
                ...
                <div>
                    <!--<div style="margin-bottom: 20px;margin-left: 60px">基础信息</div>-->
                    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                        <div class="display_flex">
                            ...
                            <div style=" width: 50%">
                                ...
                                <el-form-item label="技能" prop="skillsName">
                                    <el-select multiple placeholder="请选择技能" v-model="ruleForm.skillsName" clearable>
                                        <el-option
                                                :value="skills.id"
                                                :label="skills.label"
                                                :key="skills.id"
                                                style="height: auto"
                                        >
                                            <el-tree :data="skills" :props="defaultProps"
                    ...
                    <div class="display_flex" style="justify-content: flex-end;margin-right: 70px;padding-top: 30px">
                        <el-button v-on:click="add('ruleForm')">保存</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            getSkillstree() {
                ...
                serviceApi.workerSkills({option}).then((data) => {
                    this.skills = data
            ...
            handleNodeClick(data) {
                this.skillsValue = data;
                if (data.depth > 0) {
                    if (this.skillsName.indexOf(data.label) == -1) {
                        this.skillsName.push(data.label);
                        this.skillsId.push(data.id);
                    }
                }
                    ...
                    if (valid) {
                        let option = {
                            data: {
                                ...
                                countryId: this.countriesId,
                                skills: this.skillsId

                            }
                        }
                        serviceApi.applyWorker(option).then((data) => {
                            this.$router.go(-1);
                        }).catch(() => {
                            this.loading = false
                        })
...
<style scoped lang="scss">
    @import "../../assets/css/man/skills.css";
