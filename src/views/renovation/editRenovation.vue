...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.getRenovationId(this.renovationId);
        ...
        methods: {
            ...
            getRenovationId(id) {
                ...
                serviceRenovationApi.editDetail(option).then((data) => {

                    this.ruleForm.team = data.team;
                    this.ruleForm.beginTime = data.beginTime;
                    this.ruleForm.durationDays = data.durationDays;
            ...
            add(formName) {
                this.$refs[formName].validate((valid) => {
                    ...
                    serviceRenovationApi.edit(option).then((data) => {
                        this.$router.go(-1);
                    }).catch(() => {
                        this.loading = false
                    })
            ...
            deleted(row) {
                ...
                this.$confirm('确定要删除?', '', {
                    ...
                    if (row.id) {
                        ...
                        serviceRenovationApi.deleted(option).then((data) => {
                            this.getRenovationId(this.renovationId)
                        }).catch(() => {
                            this.loading = false
                        })
