<template>
    <div>
                    ...
                    <el-tab-pane v-for="item in pList"
                        ...
                        <draggable v-model="twoList"
                            ...
                            <div v-for="i in twoList" style="margin-bottom: 30px" v-if="item.id == i.pid">
                                <span style="font-size: 16px" @dblclick="edit(i.id)">{{i.name}}</span>
                                ...
                                <div style="display: flex;margin-top: 10px;">
                                    <draggable v-model="threeList"
                                        ...
                                        <div style="text-align: center;margin-right: 20px" v-for="j in threeList"
                                             :key="j.id" v-if="i.id == j.pid" @dblclick="edit(j.id)">
        ...
        <addType ref="addDetails" @getData="getData()"></addType>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            pEdit() {
                if (this.pID !== "") {
                    this.$refs.addDetails.show(this.pID);
                } else {
                    alert("请选择编辑的对象")
                }
            },
            chooseTab(data) {
                this.pID = data.$attrs.value;
            },
            getList() {
                this.pList = [];
                this.twoList = [];
