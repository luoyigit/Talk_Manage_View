            ...
            <div style="background-color: white">
                ...
                <div>
                        ...
                        <div class="display_flex">
                            <div style=" width: 30%">
                                ...
                                <el-form-item label="工程面积" prop="areaSize">
                                    <el-input v-model="ruleForm.areaSize" placeholder="请输入工程面积" style=" width: 202px;"
                            ...
                            <div style=" width: 50%">
                                ...
                                <el-form-item label="详细地址" prop="address">
                                    <el-input v-model="ruleForm.address" placeholder="请输入详细地址" style=" width: 310px;"
                                              clearable></el-input>
                                </el-form-item>
                    ...
                    <div class="display_flex" style="justify-content: flex-end;margin-right: 70px;padding-top: 30px">
                        <el-button v-on:click="addProject('ruleForm')">保存</el-button>
            ...
            addProject(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        serviceProjectApi.addProject(option).then((data) => {
                            this.$router.go(-1);
