// 部门
class Department {
    constructor({id, name, parentId, staffList, postList, sortIndex, shortName, leaders, higherLeaders}) {
        this.id = id
        this.name = name // 部门名称
        ...
        this.leaders = leaders ? leaders : [], // 部门领导
        this.higherLeaders = higherLeaders ? higherLeaders : [] // 上级领导
    }
}
